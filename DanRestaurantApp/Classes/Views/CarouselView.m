    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        if ([UIScreen mainScreen].bounds.size.width > 320) {
            ...
            if([UIScreen mainScreen].bounds.size.height > 480) {
                ...
                //Create Description label
                UILabel *description = [[UILabel alloc]initWithFrame:CGRectMake(0, 210, 250, 125)];
                ...
                //Create Price label
                UILabel *price = [[UILabel alloc]initWithFrame:CGRectMake(0, 220, 250, 125)];
                ...
                //Create Calories label
                UILabel *calories = [[UILabel alloc]initWithFrame:CGRectMake(0, 230, 250, 125)];
