...
+ (void)saveEmployee:(NSArray *)json {
    ...
    new_employee.employee_id = [[json objectAtIndex:0] valueForKey:@"employee_id"];
    new_employee.personal_number = [[json objectAtIndex:0] valueForKey:@"personal_number"];
    new_employee.name = [[json objectAtIndex:0] valueForKey:@"employee_name"];
